...
export class UserService {
  ...
  //   return this .httpclient.get(URL+ "profile_get/")
  // }

  profiledatabyid(id:any): Observable<any>{
    return this.httpclient.get(URL+"admin_profile_get_by_id/"+id)
  }
  ...
  usersactiveorinactive(): Observable<any>{
